<template>
    <div class="carousel relative shadow-2xl bg-gray">
...
const Carrousel = defineComponent({
});
...
<style>
			...
			#carousel-3:checked ~ .control-3 ~ .carousel-indicators li:nth-child(3) .carousel-bullet {
				color: #fceb00;  /*Set to match the Tailwind colour you want the active one to be */
			}
</style>
